...
public class SoundManager {
	...
	private void playSound(XSound xSound, Player player, float volume, float pitch) {
...
//		xSound.play(player.getLocation(), volume, pitch);
	...
	public void playGameStartingSound(Player player) {
		XSound sound = getSound(GameValues.Sounds.STARTING_SOUND);
		playSound(sound, player, GameValues.Sounds.STARTING_VOLUME, GameValues.Sounds.STARTING_PITCH);
	}

	public void playGameStartedSound(Player player) {
		XSound sound = getSound(GameValues.Sounds.STARTED_SOUND);
	...
	public void playWinSound(Player player) {
		XSound sound = getSound(GameValues.Sounds.WIN_SOUND);
	...
	public void playGameEndSound(Player player) {
		XSound sound = getSound(GameValues.Sounds.GAME_END_SOUND);
		playSound(sound, player, GameValues.Sounds.GAME_END_VOLUME, GameValues.Sounds.GAME_END_PITCH);
	}

	public void playDeathmatchSound(Player player) {
		XSound sound = getSound(GameValues.Sounds.DEATHMATCH_SOUND);
		playSound(sound, player, GameValues.Sounds.DEATHMATCH_VOLUME, GameValues.Sounds.DEATHMATCH_PITCH);
	}

	public void playDeathmatchStartingSound(Player player) {
		XSound sound = getSound(GameValues.Sounds.DEATHMATCH_STARTING_SOUND);
		playSound(sound, player, GameValues.Sounds.DEATHMATCH_STARTING_VOLUME, GameValues.Sounds.DEATHMATCH_STARTING_PITCH);
	}

	public void playUHCLevelUpSound(Player player) {
		XSound sound = getSound(GameValues.Sounds.UHC_LEVEL_UP_SOUND);
	...
	public void playKillSound(Player player) {
		XSound sound = getSound(GameValues.Sounds.KILL_SOUND);
	...
	public void playSelectSound(Player player) {
		XSound sound = getSound(GameValues.Sounds.SELECT_SOUND);
	...
	public void playBuySound(Player player) {
		XSound sound = getSound(GameValues.Sounds.BUY_SOUND);
		playSound(sound, player, GameValues.Sounds.BUY_VOLUME, GameValues.Sounds.BUY_PITCH);
	}

	public void playPurchaseCancelSound(Player player) {
		XSound sound = getSound(GameValues.Sounds.PURCHASE_CANCEL_SOUND);
